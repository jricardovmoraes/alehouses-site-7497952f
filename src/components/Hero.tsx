...
const content = {
  pt: {
    ...
    description: "Intermediação imobiliária especializada em atender estrangeiros que desejam comprar imóveis em Portugal, com acompanhamento completo em todas as etapas.",
